# Awesome Neobanks [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)

> A curated list of neobanks and payment services worldwide.

🌐 **Browse online:**
[ittermit.github.io/awesome-neobanks](https://ittermit.github.io/awesome-neobanks)
...
- [Payment Systems](#payment-systems)
  - [Payment Gateways & Processors](#payment-gateways--processors)
  - [Cross-Border & FX](#cross-border--fx)
  - [Buy Now Pay Later](#buy-now-pay-later)
  - [Open Banking](#open-banking)
  - [Banking-as-a-Service](#banking-as-a-service)
  - [Crypto & Web3 Payments](#crypto--web3-payments)
  - [Directories & Catalogs](#directories--catalogs)
...
| ----------------------------------------- | --------------- | --------------------------------------------------------------------------- |
| [Revolut](https://revolut.com)            | 🇬🇧 UK / Global  | Financial super app — cards, crypto, stock trading, multi-currency accounts |
| [N26](https://n26.com)                    | 🇩🇪 Germany / EU | Mobile bank with instant account setup and travel-friendly features         |
| [Monzo](https://monzo.com)                | 🇬🇧 UK           | Smart spending analytics, savings pots, and transparent fee structure       |
| [Starling Bank](https://starlingbank.com) | 🇬🇧 UK           | Award-winning neobank for personal and business accounts                    |
| [Bunq](https://bunq.com)                  | 🇳🇱 Netherlands  | Sustainability-focused European neobank with travel cards                   |
| [Vivid Money](https://vivid.money)        | 🇩🇪 Germany      | Cash back on purchases, investments, and multi-currency accounts            |
...
| Name                                | Country        | Description                                                       |
| ----------------------------------- | -------------- | ----------------------------------------------------------------- |
| [Kakao Bank](https://kakaobank.com) | 🇰🇷 South Korea | Largest neobank integrated with KakaoTalk messaging               |
| [Toss](https://toss.im)             | 🇰🇷 South Korea | Super app combining banking, investments, insurance, and payments |
...
| [Judo Bank](https://judo.bank)      | 🇦🇺 Australia   | Relationship banking challenger for SMEs                          |
| [Tonik](https://tonikbank.com)      | 🇵🇭 Philippines | Southeast Asia's first licensed digital-only neobank              |
| [SeaBank](https://seabank.co.id)    | 🇸🇬 SEA         | Digital bank by Sea Group with high-interest savings              |
| [Trust Bank](https://trustbank.sg)  | 🇸🇬 Singapore   | Singapore neobank by Standard Chartered with savings and credit   |
...
| Name                               | Country         | Description                                                    |
| ---------------------------------- | --------------- | -------------------------------------------------------------- |
| [Wio Bank](https://wio.io)         | 🇦🇪 UAE          | Embedded finance platform and digital bank for businesses      |
| [Zand Bank](https://zand.ae)       | 🇦🇪 UAE          | UAE's first fully digital bank for corporates and SMEs         |
| [Liv](https://liv.me)              | 🇦🇪 UAE          | Emirates NBD digital lifestyle bank for millennials            |
| [YAP](https://yap.com)             | 🇦🇪 UAE          | Digital payment platform with multi-currency and virtual cards |
| [Kuda Bank](https://kudabank.com)  | 🇳🇬 Nigeria      | Nigeria's free digital bank — accounts, savings, transfers     |
...
| Name                                       | Description                                                               |
| ------------------------------------------ | ------------------------------------------------------------------------- |
| [Stripe](https://stripe.com)               | Developer-first payment processing for online businesses and marketplaces |
| [Adyen](https://adyen.com)                 | Global payments platform for enterprises with omnichannel coverage        |
| [PayPal](https://paypal.com)               | World's most recognised online payment platform                           |
| [Checkout.com](https://checkout.com)       | Cloud-native global payment processing with high acceptance rates         |
| [Braintree](https://braintreepayments.com) | PayPal-owned gateway for seamless web and mobile payments                 |
| [Square](https://squareup.com)             | Payment processing and business tools for online and in-person merchants  |
| [Worldpay](https://worldpay.com)           | Global payment processing and merchant acquiring                          |
| [Mollie](https://mollie.com)               | European PSP with simple integration and 30+ payment methods              |
| [Razorpay](https://razorpay.com)           | India's leading payment gateway with 100+ payment methods                 |
| [PayU](https://payu.com)                   | Payment leader in high-growth markets across Europe, Asia, and LatAm      |
| [Paddle](https://paddle.com)               | Merchant of Record for SaaS with global tax compliance                    |
| [Mangopay](https://mangopay.com)           | Payment infrastructure for marketplaces and platforms                     |

### Cross-Border & FX

| Name                                       | Description                                                                 |
| ------------------------------------------ | --------------------------------------------------------------------------- |
| [Wise](https://wise.com)                   | Mid-market exchange rates with transparent fees for international transfers |
| [Payoneer](https://payoneer.com)           | Global payments for freelancers, marketplaces, and cross-border commerce    |
| [Airwallex](https://airwallex.com)         | Global payments and financial operations for international businesses       |
| [Currencycloud](https://currencycloud.com) | Visa-owned API platform for cross-border payments and FX                    |
| [Remitly](https://remitly.com)             | Consumer-focused international money transfer with guaranteed rates         |
| [OFX](https://ofx.com)                     | International money transfer and FX for individuals and businesses          |

### Buy Now Pay Later

| Name                             | Description                                                  |
| -------------------------------- | ------------------------------------------------------------ |
| [Klarna](https://klarna.com)     | Sweden's BNPL leader with Pay Later, Pay in 3, and financing |
| [Afterpay](https://afterpay.com) | Australian BNPL with pay-in-4 installments (owned by Block)  |
| [Affirm](https://affirm.com)     | US BNPL leader with transparent financing and no hidden fees |
| [Zilch](https://zilch.com)       | UK BNPL that works everywhere Mastercard is accepted         |

### Open Banking

| Name                               | Description                                                           |
| ---------------------------------- | --------------------------------------------------------------------- |
| [Plaid](https://plaid.com)         | API platform connecting apps to users' bank accounts in US and Europe |
| [Tink](https://tink.com)           | Visa-owned open banking platform for payments and data in Europe      |
| [TrueLayer](https://truelayer.com) | Open banking network for instant bank payments and payouts            |
| [Yapily](https://yapily.com)       | Open banking infrastructure connecting businesses to banks in Europe  |
| [Nordigen](https://nordigen.com)   | GoCardless-owned open banking data platform with free tier            |
| [Finicity](https://finicity.com)   | Mastercard-owned financial data aggregation platform                  |

### Banking-as-a-Service

| Name                                        | Description                                                            |
| ------------------------------------------- | ---------------------------------------------------------------------- |
| [Marqeta](https://marqeta.com)              | Modern card issuing platform powering neobanks with programmable cards |
| [Galileo](https://galileo-ft.com)           | SoFi-owned API platform for payment cards and digital banking          |
...
| Name                                                                   | Description                                                            |
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| [bankfor.you](https://bankfor.you/)                                    | Catalog of neobanks and payment services with profiles and comparisons |
| [Awesome Fintech](https://github.com/awesomelistsio/awesome-fintech)   | Curated list of fintech tools, libraries, and resources                |
| [Awesome Payments](https://github.com/brandonhimpfen/awesome-payments) | Curated list of online payment services and resources                  |
...
- The service must be live and publicly available
- Include name, URL, and a concise, neutral description (max 120 chars)
- Add to the correct region and category
